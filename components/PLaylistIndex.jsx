    ...
    >
          ...
          <div className="space-y-1">
            ...
            <div className="flex space-x-1">
              ...
              <p className="text-white">
                ...
                <span className="font-[12px]">{obj?.tracks.total} Songs,</span>
              </p>
              <p className="text-slate-400 font-sans">
                {formatTIme(
                  totalDuration()?.reduce((partialSum, a) => partialSum + a, 0),
                  "ms"
                )}
              </p>
            </div>
      ...
      <div className="w-full min-h-[50%] glass_bg2 rounded-none">
        <div className="flex space-x-5 p-3">
          ...
          />
          <MoreHorizIcon sx={{ fontSize: "60px" ,color:'rgb(209, 212, 207'}} />
        </div>
